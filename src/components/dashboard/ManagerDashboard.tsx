/**
 * Дашборд менеджера производства
 */
...
import { Package, FileText, Printer, BarChart, Users } from 'lucide-react';
...
const ManagerDashboard: React.FC = () => {
  ...
  const quickActions = [
    ...
    {
      title: 'Производство',
      description: 'Запуск и отслеживание',
      icon: Printer,
      href: 'production',
  ...
  const stats = [
    ...
    { label: 'Ожидают маркировки', value: '7', change: '-2' },
    { label: 'Всего моделей', value: '156', change: '+0' }
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Заказы в работе за последние 24 часа</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between py-2 border-b">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium">Шкаф-купе "Премиум"</p>
                    <p className="text-sm text-gray-600">25 единиц • В производстве</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between py-2 border-b">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium">Комод "Классик"</p>
                    <p className="text-sm text-gray-600">15 единиц • Ожидает маркировки</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between py-2">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium">Стол письменный "Офис"</p>
                    <p className="text-sm text-gray-600">30 единиц • Завершено</p>
                  </div>
                </div>
